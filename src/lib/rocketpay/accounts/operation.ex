defmodule Rocketpay.Accounts.Operation do
  ...
  def call(%{"id" => id, "value" => value}, operation) do
    ...
    |> Multi.run(operation, fn repo, changes -> update_balance(repo, Map.get(changes, account_operation), value, operation) end)
  end
  ...
  defp update_balance(repo, %Account{} = account, value, operation) do
    account
